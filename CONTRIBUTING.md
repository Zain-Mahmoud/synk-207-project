...
### 1. Create a Branch
Create a new branch for your feature or fix (please use an appropriate name). Do not work directly on the `main` or `master` branch.

```bash
# Good branch names
git checkout -b feature/add-new-login
git checkout -b fix/header-alignment-bug
